...
# NOTE: must use list(filter(_filter, [...])) with a literal list so that the
# integrity test can statically parse the module order (e.g. to verify that
# mossy_link appears immediately after preferences).
